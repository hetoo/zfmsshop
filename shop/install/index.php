...
<div class="header">
  <div class="layout">
    ...
    <div class="version">版本: 2018.03.15.14200</div>
  </div>
</div>
...
<div class="footer">
  ...
  <h6>版权所有 2007-2017 &copy; <a href="http://www.shopnc.net" target="_blank">天津市网城科技股份有限公司</a></h6>
  <h6>软件注册登记编号：软著登字第1251742号</h6>
</div>
EOF;
...
function step3(&$install_error,&$install_recover){
    ...
    $mysqli->query("INSERT INTO {$db_prefix}store (`store_id`,`store_name`,`grade_id`,`member_id`,`member_name`,`seller_name`,`store_state`,`store_time`,`is_own_shop`,`bind_all_gc`,`default_im`) VALUES ('1','{$store_name}','0','1','{$member_name}','{$seller_name}','1', '". time() ."', '1', '1','1')");
    ...
    $fp = @fopen('lock','wb+');
    @fclose($fp);
    exit("<script type=\"text/javascript\">document.getElementById('install_process').innerHTML = '安装完成，下一步...';document.getElementById('install_process').href='index.php?step=5&sitename={$sitename}';</script>");
    exit();
}
