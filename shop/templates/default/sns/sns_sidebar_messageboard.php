...
<div class="side-message">
  ...
  <div class="guest-form">
    <form id="send_form" action='index.php?act=member_snshome&op=savemsg&type=sns_board' method="post">
  ...
  <div nctype="message_list" class="message-list">
    ...
    <dl nctype="dl<?php echo $val['message_id'];?>">
      ...
      <dd data-param="{'msgid':'<?php echo $val['message_id'];?>','fname':'<?php echo $val['from_member_name'];?>'}"><span class="time"><?php echo $val['message_time'];?></span><span class="handle">
        ...
        <a  onclick="ajax_get_confirm('<?php echo $lang['nc_common_op_confirm'];?>', 'index.php?act=member_snshome&op=dropcommonmsg&drop_type=sns_msg&message_id=<?php echo $val['message_id'];?>');" href="javascript:void(0);"><?php echo $lang['nc_delete'];?></a>
        <?php }?>
        </span> </dd>
