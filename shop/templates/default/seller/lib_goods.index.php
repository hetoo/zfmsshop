...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="act" value="store_lib_goods" />
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="nscs-table-handle">
        <span><a href="javascript:void(0)" class="btn-mint" nc_type="dialog" dialog_title="认领商品：<?php echo str_cut($val['goods_name'],50); ?>" dialog_id="map_edit" dialog_width="480" uri="index.php?act=store_lib_goods&op=edit_goods&gc_id=<?php echo $val['gc_id']; ?>&goods_id=<?php echo $val['goods_id']; ?>" href="" class="btn-bluejeans"><i class="icon-edit"></i>
        <p>认领</p>
        </a></span></td>
    </tr>
    <?php } ?>
...
function gcategoryChange(){
    ...
    if (this.value > 0){
        var _self = this;
        var url = SITEURL + '/index.php?act=store_lib_goods&op=ajax_goods_class';
