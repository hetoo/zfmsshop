    ...
    <div id="printarea">
      ...
      <div class="orderprint">
        ...
        <table class="buyer-info">
          ...
          <tr>
            <td>配送方式<?php echo $lang['nc_colon'];?><?php echo $output['order_info']['order_type'] == 3 ? '自提' : '快递';?></td>
            <td colspan="2"><?php echo $lang['member_printorder_address'].$lang['nc_colon']; ?><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?></td>
          </tr>
          <tr>
            ...
            <td><?php if ($output['order_info']['shipping_code']){?>
