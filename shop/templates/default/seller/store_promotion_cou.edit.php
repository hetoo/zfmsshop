...
if (empty($g)) continue; ?>
            <tr class="off-shelf" data-product-id="<?php echo $g['goods_id']; ?>">
              ...
              <td class="tl"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $g['goods_id'], )); ?>" target="_blank"> <?php echo $g['goods_name']; ?> </a></td>
...
<?php } ?>
          ...
          <tbody id="cou-sku-item-tpl" style="display:none;">
            <tr class="off-shelf" data-product-id="__id">
              ...
              <td class="tl"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => '__id', )); ?>" target="_blank"> __name </a></td>
...
$(function() {
    ...
    $("[data-cou-level-sku-add-button]").live('click', function() {
        ...
        $("#cou-level-sku-container-"+id).find('img[data-src]').each(function() {
