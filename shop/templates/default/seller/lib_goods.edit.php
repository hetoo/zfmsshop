<div class="eject_con">
  ...
  <form id="post_form" method="post" action="index.php?act=store_lib_goods&op=edit_goods&gc_id=<?php echo $output['goods']['gc_id']; ?>&goods_id=<?php echo $output['goods']['goods_id']; ?>">
