...
<div class="alert alert-block mt10">
  <ul class="mt5">
    ...
    <li>4、订单全部退款中的订单不能进行发货，拼团订单只有成团后才能发货。</li>
  </ul>
</div>
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    ...
    <tr>
      ...
      <td class="w250"><input type="text" class="text w70" name="query_start_date" id="query_start_date" value="<?php echo $_GET['query_start_date']; ?>" /><label class="add-on"><i class="icon-calendar"></i></label>
        &nbsp;&#8211;&nbsp;
      ...
      <td class="bdl bdr order-info w500" rowspan="<?php echo $order['goods_count'];?>"><dl>
        ...
        <dl>
          ...
          <dd>
            <div class="alert alert-info m0">
              ...
              <p class="mt5" title="<?php echo $lang['store_deliver_buyer_address'];?>"><i class="icon-map-marker"></i><?php echo $order['extend_order_common']['reciver_info']['address'];?>
                </p>
        ...
        <dl>
          ...
          <dd>
            ...
            <?php }?>
                <?php if ($order['chain_count']){?>
                （<?php echo $order['chain_count'];?>个门店支持发货）
                <a href="javascript:void(0)" class="ncbtn-mini ncbtn-bittersweet ml5" uri="index.php?act=store_deliver&op=chain&order_id=<?php echo $order['order_id']; ?>" dialog_width="480" dialog_title="分派订单" nc_type="dialog" dialog_id="seller_order_chain" id="order<?php echo $order['order_id']; ?>_action_delay_receive" />分派订单</a>
                <?php if ($order['chain_sender_state'] >= 0) {?><span class="red">（已分派）</span><?php }?>
                <?php }?>
