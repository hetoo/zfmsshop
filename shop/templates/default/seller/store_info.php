...
<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tr>
        ...
        <th>员工总数：</th>
        <td colspan="20"><?php echo $output['joinin_detail']['company_employee_count'];?>&nbsp;人</td>
    </tr>
    <tr>
        <th>联系人姓名：</th>
...
<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
        ...
        <tr>
            <th>营业执照<br />
                电子版：</th>
            <td colspan="20"><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>" target="_banlk"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_elc']);?>" alt="" /> </a></td>
        </tr>
    </tbody>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tr>
        ...
        <td colspan="20">
            <?php if($output['joinin_detail']['other_qualification_electronic_1'] != ''){?>
                <a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['other_qualification_electronic_1']);?>" target="_banlk"> 
            ...
            <?php if($output['joinin_detail']['other_qualification_electronic_2'] != ''){?>
                <a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['other_qualification_electronic_2']);?>" target="_banlk"> 
...
<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
        <tr>
            <th>一般纳税人证明：</th>
            <td colspan="20"><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" target="_banlk"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" alt="" /> </a></td>
        </tr>
    </tbody>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
