  ...
  <table class="search-form">
    ...
    <tr>
      ...
      <th> <select name="search_type">
          <option value="0" <?php if ($_GET['search_type'] == 0) {?>selected<?php }?>><?php echo $lang['store_goods_index_goods_name'];?></option>
          <option value="1" <?php if ($_GET['search_type'] == 1) {?>selected<?php }?>><?php echo $lang['store_goods_index_goods_no'];?></option>
      ...
      <th style="text-align: center;width: 30px;padding: 5px;">库存</th>
      <td class="w120">
          <input type="text" class="text w40" name="storage_b" value="<?php echo $_GET['storage_b']; ?>"/>
          <span>-</span>
          <input type="text" class="text w40" name="storage_e" value="<?php echo $_GET['storage_e']; ?>"/>
      </td>
