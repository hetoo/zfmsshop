...
<div class="alert alert-block hr32">
  ...
  <div>
    ...
    <?php }?>
    <?php if ($output['allow_member_price']) {?>
      <a class="ncbtn ncbtn-mint ml30" href="<?php echo urlShop('store_goods_online', 'edit_member_price', array('commonid' => $_GET['commonid'], 'ref_url' => urlShop('store_goods_online', 'index')));?>"><i class="icon-edit-sign"></i>为该商品设置会员等价价格</a>
    <?php }?>
  </div>
  <div class="hr16"></div>
  <strong>
