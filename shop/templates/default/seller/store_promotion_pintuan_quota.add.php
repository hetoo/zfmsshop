...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?act=store_promotion_pintuan&op=quota_add_save" method="post">
    <dl>
      <dt><i class="required">*</i>套餐购买数量<?php echo $lang['nc_colon'];?></dt>
      <dd>
          <input id="pintuan_quantity" name="pintuan_quantity" type="text" class="text w30" /><em class="add-on">月</em><span></span>
        <p class="hint">购买单位为月(30天)，您需要支付<?php echo $output['setting_config']['promotion_pintuan_price'].$lang['nc_yuan'];?> ; </p>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
    	...
    	submitHandler:function(form){
            var unit_price = <?php echo $output['setting_config']['promotion_pintuan_price'];?>;
            var quantity = $("#pintuan_quantity").val();
