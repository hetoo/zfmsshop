...
<table class="ncsc-default-table">
  ...
  <tbody nctype="choose_goods_list">
    <tr nctype="tr_no_promotion" style="display:none;">
      <td colspan="20" class="norecord"><div class="no-promotion"><i class="zw"></i><span>F码商品列表暂无内容，请选择添加F码商品。</span></div></td>
    </tr>
...
$(function(){
    ...
    $('input[nctype="btn_search_goods"]').click(function(){
        ...
        $('div[nctype="div_goods_search_result"]').html('').load(_url+ '&' + $.param({goods_name: $('input[nctype="search_goods_name"]').val()}));
    });
