    ...
    <div class="ncm-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><span><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>，</span><span><?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?>，</span><span><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?></span>
          <span><?php if($output['order_info']['extend_order_common']['reciver_info']['dlyp']) { ?>(门店代收费用：<?php echo $output['order_info']['extend_order_common']['reciver_info']['chain_price'];?>)<?php } ?></span></dd>
        </dl>
        <dl>
          <dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
          <dd>
        ...
        <dl>
          ...
          <dd><?php echo $output['order_info']['extend_store']['store_name']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
            ...
            <div class="msg"> <span member_id="<?php echo $output['order_info']['extend_store']['default_im'];?>"></span>
