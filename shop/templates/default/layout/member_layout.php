  ...
  <div class="ncm-header">
    ...
    <div class="ncm-header-nav">
      <ul class="nav-menu">
        ...
        <?php if(C('distribute_isuse') && in_array($output['member_info']['distri_state'], array(2,4,5)) && $output['member_info']['distri_show'] == 1){?>
        <li class="distri"><a href="<?php echo urlDistribute('distri_center', 'home');?>">分销中心<i></i></a> 
            <div class="sub-menu">
            <dl>
              <dt><a href="<?php echo urlDistribute('distri_goods', 'goods_list');?>" style="color: #398EE8;">分销管理</a></dt>
              <dd><a href="<?php echo urlDistribute('distri_goods', 'goods_list');?>">分销商品</a></dd>
              <dd><a href="<?php echo urlDistribute('distri_order', 'order_list');?>">分销订单</a></dd>
              <dd><a href="<?php echo urlDistribute('distri_bill', 'bill_list');?>">分销结算</a></dd>
            </dl>
            <dl>
              <dt><a href="<?php echo urlDistribute('access_infomation', 'member')?>" style="color: #3AAC8A">结算中心</a></dt>
              <dd><a href="<?php echo urlDistribute('access_infomation', 'member');?>">账户设置</a></dd>
              <dd><a href="<?php echo urlDistribute('commission', 'commission_info')?>">账户余额</a></dd>
              <dd><a href="<?php echo urlDistribute('cash','cash_list');?>">提现记录</a></dd>
            </dl>
          </div>
        </li>
        <?php }?>
