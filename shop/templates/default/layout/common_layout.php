<?php defined('IN_TPL') or exit('Access Invalid!');?>
<!doctype html>
<html lang="zh">
<head>
    ...
    <div class="head-search-layout">
      <div class="head-search-bar" id="head-search-bar">
        ...
        <form action="<?php echo SHOP_SITE_URL;?>" method="get" class="search" id="top_search_form">
          ...
          <input name="op" id="search_op" value="<?php echo $_GET['op'] == 'store'?'store':'index';?>" type="hidden">
          <?php
      			if ($_GET['keyword']) {
          ...
          <div id="searchTxt" class="searchTxt" onmouseout="this.className='searchTxt';" onmouseover="this.className='searchTxt searchTxtHover';">
            <div class="searchMenu">
              <div id="searchSelected" class="searchSelected"><?php echo $_GET['op'] == 'store'?'店铺':'商品';?></div>
            ...
            <input id="keyword" class="ui-autocomplete-input" placeholder="<?php echo $keyword_name ? $keyword_name : '请输入您要搜索的关键字';?>" value="<?php echo $keyword;?>" data-value="<?php echo rawurlencode($keyword_value);?>" name="keyword" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true" type="text">
          </div>
          <div class="searchBtn">
