...
var chain_goods_id = '<?php echo $output['current_goods_info']['goods_id'];?>';
var chain_goods_num = '<?php echo $output['current_goods_info']['goods_num'];?>';
var chain_cart_id = '<?php echo $_POST['cart_id'][0];?>';
//哪 些商品ID不可以门店自提
