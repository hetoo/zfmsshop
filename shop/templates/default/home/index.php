...
<!--StandardLayout End-->
<div class="wrapper">
  <div class="mt10 mb10"><?php echo loadadv(9,'html');?></div>
  <div class="viewed_list">
    <?php require(BASE_TPL_PATH.'/home/viewed.item.php');?>
    <div class="item none">
    </div>
  </div>
...
$(function(){
	$container.infinitescroll({  
        ...
        maxPage : 6,
        path: function(p) {
            return "index.php?act=index&op=viewed_list&curpage=" + (p-1);
        },
        loading: {
        	selector:'#page-nav',
