  ...
  <ul class="list_pic">
    ...
    <li class="item">
      <div class="goods-content" nctype_goods=" <?php echo $value['goods_id'];?>" nctype_store="<?php echo $value['store_id'];?>">
        ...
        <?php } elseif (C('promotion_allow') && $value['goods_promotion_type'] == 3)  {?>
        <div class="goods-promotion"><span>秒杀</span></div>
        <?php } elseif (C('promotion_allow') && $value['goods_promotion_type'] == 4)  {?>
        <div class="goods-promotion"><span>闪购</span></div>
        <?php }?>
