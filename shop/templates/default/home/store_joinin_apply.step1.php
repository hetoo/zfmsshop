  ...
  <form id="form_company_info" action="index.php?act=store_joinin&op=step2" method="post">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i>营业执照详细地址：</th>
          <td><input name="business_licence_address_detail" type="text" class="w200" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>营业执照有效期：</th>
        ...
        <tr>
          <th class="w150">特殊行业资质：</th>
          <td>
              <select name="special_business">
                  <option value="0">-请选择-</option>
                  <option value="1">医疗行业</option>
                  <option value="2">食品行业</option>
                  <option value="3">书籍音像</option>
                  <option value="4">酒类制品</option>
              </select>
              <span class="block">如无特殊行业资质，无需选择。</span>
          </td>
        </tr>
        <tr>
          <th>其他资质电子版（一）：</th>
          <td><input name="other_qualification_electronic_1" type="file" class="w60"/>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="other_qualification_electronic_11" type="hidden"/><span></span>
            </td>
        </tr>
        <tr>
          <th>其他资质电子版（二）：</th>
          <td><input name="other_qualification_electronic_2" type="file"  class="w60"/>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="other_qualification_electronic_21" type="hidden"/>
            <span></span>
            </td>
        </tr>
      </tbody>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          <th><i>*</i>法人姓名：</th>
          <td><input name="legal_person_name" type="text" class="w100" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>法人身份证号：</th>
          <td><input name="legal_person_card_id" type="text" class="w100" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>证件有效期：</th>
          <td><input id="card_start_time" name="card_start_time" type="text" class="w90" />
            <span></span>-
            <input id="card_end_time" name="card_end_time" type="text" class="w90" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>法人证件电子版<br>（正面）：</th>
          <td><input name="card_before_elc" type="file"  class="w60"/>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="card_before_elc1" type="hidden"/>
            <span></span>
            </td>
        </tr>
        <tr>
          <th><i>*</i>法人证件电子版<br>（反面）：</th>
          <td><input name="card_back_elc" type="file"  class="w60"/>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="card_back_elc1" type="hidden"/>
            <span></span>
            </td>
        </tr>
      </tbody>
...
$(document).ready(function(){
	<?php foreach (array('business_licence_number_elc','general_taxpayer','other_qualification_electronic_1','other_qualification_electronic_2','card_before_elc','card_back_elc') as $input_id) { ?>
  ...
  <?php } ?>
    ...
    $('#card_start_time').datepicker();
    $('#card_end_time').datepicker();
    ...
    $('#form_company_info').validate({
        ...
        rules : {
            ...
            business_licence_address_detail: {
                required: true,
                maxlength: 50
            },
        ...
        messages : {
            ...
            legal_person_card_id: {
                required: '请填写身份证号',
                maxlength: jQuery.validator.format("身份证号必须为{0}位"),
                minlength:jQuery.validator.format("身份证号必须为{0}位")
            },
            card_start_time: {
                required: '请选择生效日期'
            },
            ...
            card_before_elc1: {
                required: '请选择上传身份证正面电子版文件'
            },
            card_back_elc1: {
                required: '请选择上传身份证反面电子版文件'
            }
        }
    });
