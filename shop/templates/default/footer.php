    ...
    <ul>
      ...
      <li>
        <dl class="s<?php echo ''.$k+1;?>">
          ...
          <dd><i></i><a href="<?php if($article['article_url'] != '')echo $article['article_url'];else echo urlMember('article', 'show',array('article_id'=> $article['article_id']));?>" title="<?php echo $article['article_title']; ?>" target="_blank"> <?php echo $article['article_title'];?> </a></dd>
          <?php }?>
          <?php }?>
        </dl>
      </li>
...
<div id="footer" class="wrapper">
  <p><a href="<?php echo SHOP_SITE_URL;?>" target="_blank"><?php echo $lang['nc_index'];?></a>
