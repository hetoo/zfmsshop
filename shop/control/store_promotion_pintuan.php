...
class store_promotion_pintuanControl extends BaseSellerControl {
    ...
    const LINK_LIST = 'index.php?act=store_promotion_pintuan&op=index';
    const LINK_MANAGE = 'index.php?act=store_promotion_pintuan&op=pintuan_manage&pintuan_id=';
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'pintuan_list','menu_name'=>'活动列表','menu_url'=>'index.php?act=store_promotion_pintuan&op=pintuan_list'),
        );
        switch ($menu_key){
            case 'pintuan_add':
            ...
            case 'pintuan_edit':
                ...
                break;
            case 'quota_add':
                $menu_array[] = array('menu_key'=>'pintuan_add','menu_name'=>'购买套餐','menu_url'=>'index.php?act=store_promotion_pintuan&op=quota_add');
                break;
            case 'pintuan_manage':
