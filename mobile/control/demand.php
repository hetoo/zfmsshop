...
class demandControl extends mobileHomeControl{
    ...
    public function demand_infoOp(){
        ...
        if(!$result){
            ...
            $demand_info['promote_image_url'] = getMbDemandImageUrl($demand_info['promote_image']);
            $demand_info['promote_video_url'] = getMbDemandVideoUrl($demand_info['promote_video'] , 'promotefile');
            $demand_info['demand_video_url'] = getMbDemandVideoUrl($demand_info['demand_video'] , 'demandfile');
