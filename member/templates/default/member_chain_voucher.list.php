  ...
  <table class="ncm-default-table">
    <thead>
      <tr>
        ...
        <th class="w200"><?php echo $lang['voucher_voucher_usecondition'];?></th>
        <th class="w200">门店名称</th>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td></td>
        <td class="tl"><?php echo $val['voucher_code'];?>
            </td>
        <td><?php echo $lang['voucher_voucher_usecondition_desc'].$val['voucher_limit'].$lang['currency_zh'];?>
            </td>
        <td><a href="<?php echo urlShop('show_chain', 'index', array('chain_id'=>$val['chain_id']));?>"><?php echo $val['chain_name'];?></a></td>
        ...
        <td class="ncm-table-handle"><span><a href="<?php echo urlShop('show_chain', 'index', array('chain_id'=>$val['chain_id']));?>" class="btn-mint"><i class="icon-shopping-cart"></i><p>使用</p></a></span></td>
