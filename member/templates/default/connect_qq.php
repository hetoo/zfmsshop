...
<div class="nc-login-layout">
  <div class="openid"><span class="avatar"><img src="<?php echo $output['qquser_info']['figureurl_qq_1'];?>" /></span><span>您使用QQ账号<a href="#register_form"><?php echo $output['qquser_info']['nickname']; ?></a>注册成功，系统为您随机新建商城用户名<br/>
    及密码，请牢记或自行修改；也可<a href="<?php echo $output['state']?$output['state']:'index.php';?>">跳过该步骤</a>直接登录。</span></div>
      ...
      <div id="tabs_container" class="tabs-container">
        <div id="register" class="tabs-content">
          <form name="register_form" id="register_form" class="nc-login-form" method="post" action="index.php?act=connect_qq&op=register">
            ...
            <input type="hidden" value="<?php echo urlencode($output['state']);?>" name="state">
            <dl>
