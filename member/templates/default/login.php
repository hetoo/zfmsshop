...
<div class="nc-login-layout">
  ...
  <div class="arrow"></div>
    ...
    <div class="nc-login-api" id="demo-form-site">
      ...
      <?php if (C('qq_isuse') == 1){?>
      <a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=connect_qq&ref_url=<?php echo urlencode($_GET['ref_url']);?>" title="QQ账号登录" class="qq"><i></i>QQ</a>
      <?php } ?>
      <?php if (C('sina_isuse') == 1){?>
      <a href="<?php echo MEMBER_SITE_URL;?>/index.php?act=connect_sina&ref_url=<?php echo urlencode($_GET['ref_url']);?>" title="新浪微博账号登录" class="sina"><i></i>新浪微博</a>
      <?php } ?>
      <?php if (C('weixin_isuse') == 1){?>
      <a href="javascript:void(0);" onclick="ajax_form('weixin_form', '微信账号登录', '<?php echo urlLogin('connect_wx', 'index', array('ref_url' => $_GET['ref_url']));?>', 360);" title="微信账号登录" class="wx"><i></i>微信</a>
      <?php } ?>
      <?php } ?>
    </div>
  </div>
