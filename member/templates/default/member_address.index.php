...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="javascript:void(0)" class="ncbtn ncbtn-bittersweet" style="right: 100px;" nc_type="dialog" dialog_title="使用门店代收（自提）" dialog_id="daisou"  uri="index.php?act=member_address&op=delivery_add" dialog_width="900" title="使用门店代收服务"><i class="icon-flag"></i>使用门店代收服务</a>
    <?php } ?>
  </div>
