...
<ul class="cp-toast-list">
  ...
  <?php }?>
  <?php }?>
  <?php if (C('distribute_isuse')) {?>
      <?php if ($output['statistics']['distri_verify']) {?>
          <li>
              <span>[分销-分销认证]</span>
              <a target="workspace" href="<?php echo urlAdminDistribute('distri_member', 'auth_up');?>" onclick="openItem('distribute|distri_member')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['distri_verify'];?></strong>个分销认证需要审核。</a>
          </li>
      <?php }?>
      <?php if ($output['statistics']['distri_cash']) {?>
          <li>
              <span>[分销-佣金提现]</span>
              <a target="workspace" href="<?php echo urlAdminDistribute('distri_cash', 'index');?>" onclick="openItem('distribute|distri_cash')"><i class="fa fa-bell-o"></i>有<strong><?php echo $output['statistics']['distri_cash'];?></strong>个佣金提现需要处理。</a>
          </li>
      <?php }?>
  <?php }?>
</ul>