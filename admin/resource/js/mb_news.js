...
$(function(){
    ...
    $('a[nctype="mb_add_img"]').click(function(){
        $('a[nctype="meat_cancel"]').click();
        $('div[nctype="mea_img"]').show().load(ADMIN_SITE_URL+'/index.php?act=mb_news&op=pic_list&item=mobile');
        $('div[nctype="mea_video"]').hide();
    });
    // 关闭 图片选择
    ...
    $('a[nctype="mb_add_video"]').click(function(){
        $('div[nctype="mea_video"]').show().load(ADMIN_SITE_URL+'/index.php?act=mb_news&op=video_list&item=mobile');
