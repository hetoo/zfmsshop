        ...
        <div id="searchCon" class="content">
          <div class="layout-box">
            <dl>
              <dt>活动名称</dt>
              <dd>
                <input type="text" name="spike_name" class="s-input-txt" placeholder="请输入活动名称关键字" />
              </dd>
            </dl>
            <dl>
              <dt>店铺名称</dt>
            ...
            <dl>
              ...
              <dd>
                <select name="state" class="s-select">
                    <?php foreach ((array) $output['spike_state_array'] as $sk => $sv) { ?>
...
<script>
$(function(){
    var flexUrl = 'index.php?act=promotion_spike&op=get_xml';

    $("#flexigrid").flexigrid({
        url: flexUrl,
        colModel: [
            {display: '操作', name: 'operation', width: 150, sortable: false, align: 'center', className: 'handle'},
            {display: '活动名称', name: 'spike_name', width: 400, sortable: false, align: 'left'},
            ...
            {display: '状态', name: 'spike_state_text', width: 80, sortable: false, align: 'center'}
        ],
        searchitems: [
            {display: '活动名称', name: 'spike_name', isdefault: true},
