...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="<?php echo urlAdminShop('chain_voucher', 'templatelist'); ?>" title="返回列表">
  ...
  <form id="add_form" method="post" action="index.php?act=chain_voucher&op=templateedit">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" class="readonly txt" value="<?php echo $output['t_info']['voucher_t_chain_name'];?>" readonly>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
