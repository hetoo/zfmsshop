            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: left;"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a>
                    ...
                    <a onclick="CUR_DIALOG = ajax_form('add_refund', '<?php echo $goods['goods_name'];?> 退款', 'index.php?act=order&op=add_refund&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>');" href="javascript:void(0);">[退款/退货]</a>
                    <?php } ?>
