  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="allowcash_1" class="cb-enable <?php if($output['member_array']['is_cash'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['member_edit_allow'];?></span></label>
            <label for="allowcash_2" class="cb-disable <?php if($output['member_array']['is_cash'] == '0'){ ?>selected<?php } ?>" ><span><?php echo $lang['member_edit_deny'];?></span></label>
            <input id="allowcash_1" name="allowcash" <?php if($output['member_array']['is_cash'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
            <input id="allowcash_2" name="allowcash" <?php if($output['member_array']['is_cash'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
          </div>
          <p class="notic">如果禁止该项则会员不能提现预存款</p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
