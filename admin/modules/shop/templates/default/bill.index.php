...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      <li>账单计算公式：订单金额(含运费) - 佣金金额 - 退单金额 + 退还佣金 - 店铺促销费用 + 定金订单中的未退定金 + 下单时使用的平台红包 - 全部退款时应扣除的平台红包
        <?php if(C('distribute_isuse') == 1) {?>
         - 分销佣金
        <?php } ?>
        </li>
...
$(function(){
    ...
    $("#flexigrid").flexigrid({
        ...
        colModel : [
            ...
            <?php if(C('distribute_isuse') == 1) {?>
            {display: '分销佣金', name : 'ob_dis_pay_amount', width : 60, sortable : true, align: 'left'},
            <?php } ?>
