                ...
                <dd>
                    <div class="ncsc-goods-default-pic">
                        <div class="goodspic-upload">
                            <div class="upload-thumb selected"><img nctype="news_image" src="<?php echo UPLOAD_SITE_URL .'/shop/common/'.C('default_goods_image')?>"> </div>
                            <input type="hidden" name="news_image_path" id="news_image_path" nctype="news_image" value="">
