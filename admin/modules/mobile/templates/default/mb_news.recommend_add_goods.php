<div class="div-goods-select">
    <table class="search-form">
        ...
        <tr>
            ...
            <td class="w180"><input placeholder="请输入关键字..." type="text" name="b_search_keyword" class="text" value="<?php echo $_GET['keyword'];?>" /></td>
            <td class="tc w70"><a href="index.php?act=mb_news&op=recommend_add_goods" nctype="search_a" class="ncs-btn"><i class="icon-search"></i><?php echo $lang['nc_search'];?></a></td>
            <td class="w10"></td>
        </tr>
        </tbody>
    </table>
                ...
                <?php foreach ($output['goods_list'] as $val){?>
                    <li nctype="<?php echo $val['goods_commonid'];?>">
                        <div class="goods-thumb">
                            <img src="<?php echo cthumb($val['goods_image'], 240, $_SESSION['store_id']);?>" nctype="<?php echo $val['goods_image'];?>" /></div>
                        <dl class="goods-info">
                            <dt>
                                <a href="<?php echo urlShop('distri_goods', 'goods_detail', array('goods_id' => $val['goods_commonid']))?>" target="_blank" title="<?php echo '商品名称/';?><?php echo $val['goods_name'];?>">
...
<script>
    $(function(){
        ...
        $('a[nctype="search_a"]').click(function(){
            $(this).attr('href', $(this).attr('href')+ '&qtype='+$('select[name="qtype"]').val() + '&' + $.param({'keyword':$('input[name="b_search_keyword"]').val()}));
