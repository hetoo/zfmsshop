...
class distri_cashControl extends SystemControl{
    ...
    public function get_xmlOp(){
        ...
        foreach ($cash_list as $value) {
            ...
            $param['operation'] .= "<a class='btn green' href='javascript:void(0)' onclick=\"ajax_form('cash_info','查看提现编号“". $value['tradc_sn'] ."”的明细', 'index.php?act=distri_cash&op=cash_view&id=". $value['tradc_id'] ."', 640)\" ><i class='fa fa-list-alt'></i>查看</a>";
