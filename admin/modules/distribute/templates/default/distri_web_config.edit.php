...
<script type="text/javascript">
    ...
    var screen_adv_list = new Array();//焦点图广告数据
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="JavaScript:void(0)" class="current"><?php echo '焦点图';?></a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="homepage-focus" id="homepageFocusTab">
        <div class="title">
            <h3>焦点图设置</h3>
            <ul class="tab-base nc-row">
                <li><a href="JavaScript:void(0);" class="current" form="upload_screen_form"><?php echo '焦点大图';?></a></li>
            </ul>
        </div>
