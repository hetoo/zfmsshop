    ...
    <form id="search_form" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="word_name" id="word_name" class="input-txt">
                    <span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        ...
                        <input id="site_status1" name="is_open" checked="checked"  value="1" type="radio">
                        <input id="site_status0" name="is_open" value="0" type="radio">
                    </div>
