        ...
        <dd class="opt nobg nopd nobd nobs">
          <div class="ncap-account-container">
            ...
            <ul class="ncap-account-container-list">
              ...
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" id="distri_index" value="distri_index" >
                  分销首页管理</label>
              </li>
              <li>
                <label>
                  <input type="checkbox" class="checkbox" name="cache[]" id="sensitive_word" value="sensitive_word" >
                  敏感词</label>
              </li>
            </ul>
          </div>
