...
<style type="text/css">
  #fwin_set_stock .dialog_body div.content{ max-height: 400px; overflow-y: scroll; }
</style>
...
<table class="ncsc-default-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span><?php echo $lang['currency'].ncPriceFormat($output['stock_list'][$val['goods_commonid']]['chain_price']); ?></span></td>
      <td><span><?php echo intval($output['stock_list'][$val['goods_commonid']]['stock']).$lang['piece']; ?></span></td>
      <td><span><?php echo intval($output['stock_list'][$val['goods_commonid']]['goods_salenum']).$lang['piece']; ?></span></td>
...
$(function(){
    $('a[nctype="set_stock"]').click(function(){
        ...
        ajax_form('set_stock', '上架设置', '<?php echo urlChain('goods', 'set_stock');?>&common_id=' + _common_id, '800');
    });
});
</script> 
