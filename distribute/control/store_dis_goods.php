...
class store_dis_goodsControl extends BaseSellerControl {
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'dis_goods':
                $menu_array = array(
                    array('menu_key'=>'index','menu_name'=>'分销商品 ',  'menu_url'=>'index.php?act=store_dis_goods&op=index')
                );
                break;
            case 'goods_list':
                $menu_array = array(
                    array('menu_key'=>'index','menu_name'=>'分销商品 ',  'menu_url'=>'index.php?act=store_dis_goods&op=index'),
                    array('menu_key'=>'goods_list','menu_name'=>'添加商品 ',  'menu_url'=>'index.php?act=store_dis_goods&op=goods_list')
                );
                break;
        }
