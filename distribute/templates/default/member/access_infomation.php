...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncbtn ncbtn-bittersweet" href="index.php?act=access_infomation&op=distri_quit"><i class="icon-shield"></i>退出分销</a>
    <?php }?>
  </div>
  ...
  <div class="ncm-default-form">
    <form id="form_company_info" action="index.php?act=access_infomation&op=save_member" method="post">
      ...
      <dl>
        ...
        <dd>
          ...
          <span onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();">
            <img src="index.php?act=seccode&op=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"/> <a class="makecode" href="javascript:void(0)">更换验证码</a>
          </span>
        </dd>
      </dl>
      <dl class="bottom">
      ...
      <dl class="bottom">
        <dt>&nbsp;</dt>
        <dd><label class="submit-border">
          <a id="btn_apply_company_edit" href="index.php?act=access_infomation&op=member&type=edit" class="submit">编辑</a></label>
        </dd>
      </dl>
      <?php }?>
  </form>
