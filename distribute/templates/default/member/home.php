...
<div id="member_center_box" class="ncm-index-container">
  <div class="user-account">
    ...
    <dl class="account04">
      ...
      <dt>分销商品</dt>
      <dd class="icon"></dd>
      <dd class="value"><a href="<?php echo urlDistribute('distri_goods');?>">查看详情</a></dd>
      </a>
    </dl>
    <dl class="account05">
      ...
      <dt>分销订单</dt>
      <dd class="icon"></dd>
      <dd class="value"><a href="<?php echo urlDistribute('distri_order');?>">查看详情</a></dd>
      </a>
    </dl>
    <dl class="account02">
      ...
      <dt>结算管理</dt>
      <dd class="icon"></dd>
      <dd class="value"><a href="<?php echo urlDistribute('distri_bill');?>">查看详情</a></dd>
      </a>
    </dl>
  </div>
