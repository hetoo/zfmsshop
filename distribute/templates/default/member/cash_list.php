...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a class="ncbtn ncbtn-mint" href="index.php?act=cash&op=apply_cash"><i class="icon-money"></i>申请提现</a>
  </div>
  <div class="alert">
    <span class="mr30">
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      ...
      <input type="hidden" name="op" value="cash_list" />
      <tr>
      <th></th><td></td>
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td><p><a href="index.php?act=cash&op=cash_info&id=<?php echo $val['tradc_id']; ?>">查看</a></p></td>
      </tr>
      <?php } ?>
      <?php } else {?>
      <tr>
