    ...
    <?php foreach($output['goods_list'] as $value){?>
    	<li>
            ...
            <div class="d_list_shop_name">
            	<a href="index.php?act=store&store_id=<?php echo $value['store_id'];?>"><img src="<?php echo DISTRIBUTE_TEMPLATES_URL;?>/images/d_list_shop_name.png" class="fl" alt="<?php echo $value['store_name'];?>"/><span class="fl"><?php echo $value['store_name'];?></span></a>
            </div>
            <div class="add-cart checkbox">
              <a href="javascript:void(0);" data-gid="<?php echo $value['goods_commonid']?>" class="cd-popup-trigger1"><i class="fa fa-share-alt" aria-hidden="true"></i>&nbsp;立即推广</a>
              <a href="javascript:void(0);" data-gid="<?php echo $value['goods_commonid']?>" class="cd-popup-trigger2"><i class="fa fa-qrcode" aria-hidden="true"></i>&nbsp;获取二维码</a>
            </div>
        </li>
        <?php }?>      
    </ul>
...
<script type="text/javascript">
    $(function(){
        ...
        $('.cd-popup-trigger1').on('click', function(event){
            ...
            $.ajax({
                type:'get',
                url:'index.php?act=search&op=distri_add&id='+g_id,
                dataType:"json",
