...
<div id="apply_company_info" class="apply-company-info">
  ...
  <form id="form_company_info" action="index.php?act=distri_join&op=step2" method="post">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input  type="text" id="captcha" name="captcha" class="text w80" size="10"  />
            <span>
              <img src="index.php?act=seccode&op=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"/> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();">更换验证码</a>
            </span></td>
        </tr>
      </tbody>
    </table>
