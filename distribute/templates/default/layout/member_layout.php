  ...
  <div class="ncm-header">
    <div class="ncm-header-top">
      <div class="ncm-member-info">
        <div class="avatar"><a href="<?php echo urlMember('member_information', 'avatar');?>" title="修改头像"><img src="<?php echo getMemberAvatar($output['member_info']['member_avatar']);?>">
          ...
          <a href="<?php echo DISTRIBUTE_TEMPLATES_URL?>index.php?act=member_message&op=message" class="new-message" title="新消息"><?php echo intval($output['message_num']); ?></a>
          <?php }?>
        </div>
        <dl>
    ...
    <div class="ncm-header-nav">
      <ul class="nav-menu">
        ...
        <li><a href="<?php echo urlDistribute('distri_center', 'home');?>" class="current">分销中心</a> </li>
      </ul>
      <div class="notice">
        <ul class="line">
