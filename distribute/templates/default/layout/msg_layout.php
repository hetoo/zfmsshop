...
<link href="<?php echo DISTRIBUTE_TEMPLATES_URL;?>/font/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
<!--[if IE 7]>
...
<script>var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo DISTRIBUTE_SITE_URL;?>';var DISTRIBUTE_RESOURCE_SITE_URL = '<?php echo DISTRIBUTE_RESOURCE_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var DISTRIBUTE_TEMPLATES_URL = '<?php echo DISTRIBUTE_TEMPLATES_URL;?>';</script>
...
<div class="header-wrap"><header class="public-head-layout wrapper">
  <h1 class="site-logo"><a href="<?php echo DISTRIBUTE_SITE_URL;?>"><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['site_logo']; ?>" class="pngFix"></a></h1></header></div>
<div class="msg">
