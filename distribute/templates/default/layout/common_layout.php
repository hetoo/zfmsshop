...
<link href="<?php echo DISTRIBUTE_TEMPLATES_URL;?>/css/home_header.css" rel="stylesheet" type="text/css">
<link href="<?php echo DISTRIBUTE_RESOURCE_SITE_URL;?>/font/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
<link href="<?php echo DISTRIBUTE_RESOURCE_SITE_URL;?>/font/font-awesome3_2/css/font-awesome.min.css" rel="stylesheet" />
<!--[if IE 7]>
  <link rel="stylesheet" href="<?php echo DISTRIBUTE_RESOURCE_SITE_URL;?>/font/font-awesome/css/font-awesome-ie7.min.css">
  <link rel="stylesheet" href="<?php echo DISTRIBUTE_RESOURCE_SITE_URL;?>/font/font-awesome3_2/css/font-awesome-ie7.min.css">
<![endif]-->
...
<![endif]-->
<script>
var COOKIE_PRE = '<?php echo COOKIE_PRE;?>';var _CHARSET = '<?php echo strtolower(CHARSET);?>';var SITEURL = '<?php echo SHOP_SITE_URL;?>';var SHOP_SITE_URL = '<?php echo SHOP_SITE_URL;?>';var MEMBER_SITE_URL = '<?php echo MEMBER_SITE_URL;?>';var RESOURCE_SITE_URL = '<?php echo RESOURCE_SITE_URL;?>';var SHOP_TEMPLATES_URL = '<?php echo SHOP_TEMPLATES_URL;?>';var DISTRIBUTE_SITE_URL = '<?php echo DISTRIBUTE_SITE_URL;?>';var DISTRIBUTE_TEMPLATES_URL = '<?php echo DISTRIBUTE_TEMPLATES_URL;?>';
</script>
	...
	$('#button').click(function(){
	    if ($('#keyword').val() == '') {
		    if ($('#keyword').attr('data-value') == '') {
				...
				window.location.href="<?php echo DISTRIBUTE_SITE_URL?>/index.php?act=search&op=index&keyword="+$('#keyword').attr('data-value');
			    return false;
			}
	    }
	});
...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    <h1 class="site-logo">
      <a href="<?php echo DISTRIBUTE_SITE_URL;?>">
        <?php if(C('distribute_logo')){?>
        <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_DISTRIBUTE.DS.$output['setting_config']['distribute_logo']; ?>" class="pngFix">
        <?php }else{?>
        <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_DISTRIBUTE.DS.'default_logo_image.png';?>" class="pngFix">
        <?php }?>  
      </a>
    </h1>
    ...
    <div class="head-search-bar">
      <form action="<?php echo DISTRIBUTE_SITE_URL;?>" method="get" class="search-form" id="top_search_form">
      ...
      <div class="search-tip" id="search-tip">
        <div class="search-history">
          ...
          <li><a href="<?php echo urlDistribute('search', 'index', array('keyword' => $v));?>"><?php echo $v ?></a></li>
          <?php } ?>
          <?php } ?>
          </ul>
        </div>
        <div class="search-hot">
          ...
          <li><a href="<?php echo urlDistribute('search', 'index', array('keyword' => $v['value']));?>"><?php echo $v['value']?></a></li>
          <?php } ?>
          <?php } ?>
          </ul>
        </div>
      ...
      <div class="keyword">
        <ul>
          ...
          <li><a href="<?php echo urlDistribute('search', 'index', array('keyword' => $val));?>"><?php echo $val; ?></a></li>
          <?php } }?>
        </ul>
      </div>
    </div>
      ...
      <dl class="my-mall">
        ...
        <dd>
          ...
          <div class="browse-history">
            ...
            <ul>
              <li class="no-goods"><img class="loading" src="<?php echo DISTRIBUTE_TEMPLATES_URL;?>/images/loading.gif" /></li>
            </ul>
          </div>
        </dd>
      </dl>
      <dl class="my-cart">
        ...
        <dd>
          ...
          <div class="incart-goods-box">
            <div class="incart-goods"> <img class="loading" src="<?php echo DISTRIBUTE_TEMPLATES_URL;?>/images/loading.gif" /> </div>
          </div>
