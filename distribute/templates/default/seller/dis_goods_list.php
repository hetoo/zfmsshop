...
<div nctype="div_goods_select" class="div-goods-select">
    ...
    <input type="hidden" name="act" value="store_dis_goods" />
...
function select_goods(common_id){//商品选择
    var obj = $("li[select_id='"+common_id+"']").find(".ncbtn-mini");
    if(obj.html() == '选择商品') {
        obj.html('已选择');
        $.get('index.php?act=store_dis_goods&op=add_goods&id='+common_id);
    }
}
</script>