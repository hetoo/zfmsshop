...
class groupbuyModel extends Model{
     ...
     *
     */
    public function getGroupbuyOnlineList($condition, $limit = '', $order = 'state asc', $page = null, $field = '*') {
        $condition['state'] = self::GROUPBUY_STATE_NORMAL;
        $condition['start_time'] = array('lt', TIMESTAMP);
        $condition['end_time'] = array('gt', TIMESTAMP);
        return $this->getGroupbuyExtendList($condition, $page, $order, $field, $limit);
    }
     ...
     *
     */
    public function getGroupbuySoonList($condition, $limit = '', $order = 'state asc', $page = null, $field = '*') {
        $condition['state'] = self::GROUPBUY_STATE_NORMAL;
