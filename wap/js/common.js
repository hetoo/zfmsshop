...
function buildUrl(type, data) {
    switch (type) {
        ...
        case 'lottery':
            return WapSiteUrl + '/lottery_dial.html?lot_id=' + data;
        case 'url':
            return data;
    }
    return WapSiteUrl;
...
function buildDHomeUrl(type, data) {
    switch (type) {
        case 'keyword':
            return WapSiteUrl + '/tmpl/dhome/store_list.html?keyword=' + encodeURIComponent(data);
        case 'url':
            return data;
    }
    return WapSiteUrl;
...
$(function() {
    $('.input-del').click(function(){
        $(this).parent().removeClass('write').find('input').each(function(){
            if ($(this).hasClass('no-follow')) {
                return;
            }else{
                $(this).val('');
